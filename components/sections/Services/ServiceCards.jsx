...
const ServiceCards = () => {
    return (
        <div id="services" className='w-full max-w-360 h-fit flex flex-col gap-16 justify-center items-center min-h-165 borde border-black mt-32 overflow-hidden'>
            <HeadingCard head={"Websites tailored to your goals"} subHead={"Choose a plan that fits your business stage"} />
            ...
            <div className='w-full flex 2xl:flex-row flex-col gap-8 justify-center items-center'>
                <div className='lg:w-[42%] w-full lg:h-216.5 min-h-216.5 p-6 border flex flex-col justify-between border-black/40 rounded-xl bg-bg-light gap-10'>
                        ...
                        {[
                            ...
                            return (
                                <div key={index} className='w-full flex justify-start items-center gap-2'>
                                    ...
                                    <span className='text-text lg:text-[15px] text-[12px] font-'>{item}</span>
                                </div>
                            )
                        })}
                    ...
                    <div className='w-full flex flex-col gap-6 h-fit'>
                        <ConnectPopOver>
                            <div className='w-full text-text flex justify-center items-center border border-black py-3 rounded-md cursor-pointer shadow-sm shadow-white hover:shadow-[#7C3AED]/50 transition-all duration-300 ease-in-out inset-shadow-sm inset-shadow-black/10 hover:inset-shadow-white text-[15px]'>Start your project</div>
                ...
                <div className='lg:w-[45%] w-full lg:h-220 min-h-216.5 p-1.5 shadow-2xl shadow-black/15 rounded-xl bg-[#303030]'>
                    ...
                    <div className='w-full flex flex-col justify-between items-center h-full p-6 border-black rounded-lg gap-10 bg-white relative'>
                        <div className='bg-[#303030] text-white font- w-fit rounded-bl-xl px-6 py-2 text-xs absolute right-0 top-0'>Best for Growth</div>
                        ...
                        <div className='w-full h-[70%]  border-black flex flex-col gap-4 jucctify-start items-start'>
                            <span className='text-[15px] text-text mb-2 font-bold'>Everything in Tier 1, plus:</span>
                            {[
                                ...
                                return (
                                    <div key={index} className='w-full flex justify-start items-center gap-2'>
                                        ...
                                        <span className='text-text lg:text-[15px] text-[15px] font-'>{item}</span>
                                    </div>
                                )
                            })}
