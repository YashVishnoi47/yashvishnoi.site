...
const ServiceCards = () => {
    return (
        <div className='w-full h-fit flex flex-col gap-16 justify-center items-center min-h-165 borde border-black mt-32'>
            ...
            <div className='w-full flex 2xl:flex-row flex-col gap-8 justify-center items-center'>
                <div className='w-150  h-216.5 p-6 border flex flex-col justify-between border-black/40 rounded-xl bg-bg-light gap-10'>
                    <div className="gap-2 flex flex-col justify-start items-start w-full">
                        <Tag text={"Clean. Fast. Professional Online Presence."} />
                        <h4 className="lg:text-[36px] text-text text-[30px] lg:text-left font-medium text-center">
                            Core Website
                        </h4>
                        ...
                        {[
                            ...
                            return (
                                <div key={index} className='w-full flex justify-start items-center gap-2'>
                                    ...
                                    <span className='text-text/90 text-[17px] font-medium'>{item}</span>
                                </div>
                            )
                        })}
                    ...
                    <div className='w-full flex flex-col gap-6 h-fit'>
                        <ConnectPopOver>
                            <button className='w-full text-text flex justify-center items-center border border-black py-3 rounded-md cursor-pointer shadow-sm shadow-white hover:shadow-[#7C3AED]/50 transition-all duration-300 ease-in-out inset-shadow-sm inset-shadow-black/10 hover:inset-shadow-white '>Start your project</button>
                ...
                <div className='w-150  p-2 h-216.5 shadow-2xl shadow-black/15 rounded-xl bg-[#7C3AED]'>
                    ...
                    <div className='w-full flex flex-col justify-between items-center h-full p-6 border-black rounded-lg bg-bg-light gap-10'>
                        ...
                        <div className="gap-2 flex flex-col justify-start items-start w-full">
                            ...
                            <h4 className="lg:text-[36px] text-[30px] text-text lg:text-left font-medium text-center">
                                Interactive Experience Website
                            </h4>
                            <span className="text-[16px] font-light text-text-muted2 lg:text-left text-center">
