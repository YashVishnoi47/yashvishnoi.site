...
const RevealButton = ({ text, className }) => {
    ...
    >
      <motion.div
        className={cn(
          ...
          "flex justify-center items-center overflow-hidden relative z-2 bg-black text-white",
        )}
      ...
      <motion.div
        ...
        transition={{ duration: 0.9, ease: easing }}
        className="absolute inset-0 z-0 pointer-events-none bg-black/10 h-full"
      />
    </motion.div>
  );
};
